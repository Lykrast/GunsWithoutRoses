...
public class ModEnchantments {
	...
	public static Enchantment impact, bullseye, sleightOfHand, preserving, accelerator, division, passionForBlood, puncturing, marker, luckyShot, cowboy, cleanShot;
	...
	public static void registerEnchantments(final RegistryEvent.Register<Enchantment> event) {
		...
		cleanShot = initEnchant(reg, new GunEnchantment(Enchantment.Rarity.RARE, 1, 7, 14, 30, TYPE_GUN), "clean_shot");
	}
