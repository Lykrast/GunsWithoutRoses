...
public class ModItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		diamondGatling = initItem(reg, new GatlingItem(defP().maxDamage(2076), 0, 1, 4, 4, 10).ignoreInvulnerability(true).repair(() -> Ingredient.fromTag(Tags.Items.GEMS_DIAMOND)), "diamond_gatling");
