...
public class ModItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		ironGun = initItem(reg, new GunItem(defP().durability(513), 0, GunsWithoutRosesConfig.ironDamageMultiplier.get(), GunsWithoutRosesConfig.ironFireDelay.get(), 1.5, 14).repair(() -> Ingredient.of(Tags.Items.INGOTS_IRON)), "iron_gun");
		goldGun = initItem(reg, new GunItem(defP().durability(104), 0, GunsWithoutRosesConfig.goldDamageMultiplier.get(), GunsWithoutRosesConfig.goldFireDelay.get(), 1.5, 22).repair(() -> Ingredient.of(Tags.Items.INGOTS_GOLD)), "gold_gun");
		diamondShotgun = initItem(reg, new ShotgunItem(defP().durability(2076), 0, GunsWithoutRosesConfig.diamondShotgunDamageMultiplier.get(), GunsWithoutRosesConfig.diamondShotgunFireDelay.get(), 6, 10, 5).ignoreInvulnerability(true).fireSound(ModSounds.shotgun).repair(() -> Ingredient.of(Tags.Items.GEMS_DIAMOND)), "diamond_shotgun");
		diamondSniper = initItem(reg, new GunItem(defP().durability(2076), 0, GunsWithoutRosesConfig.diamondSniperDamageMultiplier.get(), GunsWithoutRosesConfig.diamondSniperFireDelay.get(), 0, 10).projectileSpeed(4).fireSound(ModSounds.sniper).repair(() -> Ingredient.of(Tags.Items.GEMS_DIAMOND)), "diamond_sniper");
